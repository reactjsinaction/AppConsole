...
extension Assertion {
    // (Int, Int)
    func equal(expression1: (Int,Int), _ expression2: (CGFloat, CGFloat), @autoclosure _ message: () -> String = "", file: StaticString = #file, function: String = #function, line: UInt = #line) {
        _XCTEvaluateAssertion(.Equal, message: message, file: file, function: function, line: line) {
    ...
    func equal(expression1: (CGFloat,CGFloat), _ expression2: (CGFloat, CGFloat), @autoclosure _ message: () -> String = "", file: StaticString = #file, function: String = #function, line: UInt = #line) {
        _XCTEvaluateAssertion(.Equal, message: message, file: file, function: function, line: line) {
            let a = expression1
            let b = expression2
            if a.0 == b.0 && a.1 == b.1 {
